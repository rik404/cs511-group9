...
# RUN wget -qO - https://archive.cloudera.com/cdh5/ubuntu/xenial/amd64/cdh/archive.key | apt-key add 
# RUN wget http://archive.cloudera.com/kudu/ubuntu/xenial/amd64/kudu/cloudera.list 
# RUN apt-get update 
# RUN apt-get -y install kudu kudu-master kudu-tserver libkuduclient0 libkuduclient-dev
